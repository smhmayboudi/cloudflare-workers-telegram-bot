...
export const isInlineQueryUpdate = (
  update: Update,
): update is TelegramUpdate.InlineQueryUpdate =>
  (update as TelegramUpdate.InlineQueryUpdate).inline_query !== undefined;

export const isMessageUpdate = (
  update: Update,
): update is TelegramUpdate.MessageUpdate =>
  (update as TelegramUpdate.MessageUpdate).message !== undefined;

export const isNewChatMembersMessage = (
  update: Update,
): update is TelegramMessage.NewChatMembersMessage =>
  (update as TelegramMessage.NewChatMembersMessage).new_chat_members !==
  undefined;

export const isTelegramPublicChat = (
  chat: TelegramChat,
): chat is TelegramPublicChat =>
  (chat as TelegramPublicChat).title !== undefined;

export const isTextMessage = (
  update: TelegramMessage.ServiceMessage,
): update is TelegramMessage.TextMessage =>
